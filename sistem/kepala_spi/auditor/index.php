              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody id="modal-data">
                      <?php foreach ($tb_auditor as $r) : ?>
                        <tr>
                          <td><?php echo $r['nama']; ?></td>
                          <td><?php echo  $r['nip_npak']; ?></td>
                          <td><?php echo  $r['jabatan']; ?></td>
                          <td>
                            <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal<?php echo $r['id_auditor']; ?>">
                              Detail
                            </a>

                            <!-- tampilan modal jadi-->
                            <div class="modal fade" id="myModal<?php echo $r['id_auditor']; ?>">
                            ...
                            <a class="btn btn-danger btn-sm" name="hapus" href="hapus.php?id=<?= $r["id_auditor"]; ?>" onclick="return confirm('Hapus?');">Hapus</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
